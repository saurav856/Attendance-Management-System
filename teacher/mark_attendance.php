...
<div class="card" style="margin-top: 20px;">
    <div class="card-header">
        <h2 class="card-title"><i class="fas fa-info-circle"></i> Attendance Status Guide</h2>
    </div>
    <div class="card-body">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px;">
            <div><span class="badge badge-success">Present</span> - Student attended class</div>
            <div><span class="badge badge-danger">Absent</span> - Student did not attend</div>
            <div><span class="badge badge-warning">Late</span> - Student arrived late</div>
        </div>
    </div>
</div>
